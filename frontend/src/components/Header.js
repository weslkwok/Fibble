...
export default function Header({ setSideBar, setFibble, fibble }) {
    ...
    return (
        <header style={{ backgroundColor: theme.background }}>
                ...
                {(close) => (
                    <div className="modal" style={{ color: theme.text }}>
                        ...
                        <ul>
                            ...
                            <ul>
                                <li>
                                    <span style={{ color: "rgb(54, 153, 72)" }}>
                                        Green
                                    </span>{" "}
                ...
                {(close) => (
                    <div className="modal" style={{ color: theme.text }}>
                        ...
                        <div className="settingsRow">
                            <h2 className="Headings">Fibble</h2>
                            <WhiteSwitch
                                checked={fibble}
                                onChange={() => setFibble((o) => !o)}
            ...
            <h1 className="MidHeader" style={{ color: theme.text }}>
                {fibble ? "Fibble" : "Wordle"}
            </h1>
